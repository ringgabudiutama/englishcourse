...
export default function LoginForm({ logoUrl, brandName }: { logoUrl?: string | null; brandName?: string | null }) {
  return (
    <Suspense fallback={null}>
      <LoginFormInner logoUrl={logoUrl} brandName={brandName} />
    </Suspense>
  );
}

function LoginFormInner({ logoUrl, brandName }: { logoUrl?: string | null; brandName?: string | null }) {
